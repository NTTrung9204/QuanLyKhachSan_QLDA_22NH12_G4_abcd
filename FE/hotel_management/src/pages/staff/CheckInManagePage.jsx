...
const CheckInManagePage = () => {
  ...
  const fetchPendingBookings = async () => {
    try {
      setLoading(true);
      const response = await api.get('/api/bookings/future-pending');
  ...
  const handleCheckIn = async (bookingId) => {
    try {
      ...
      // Refresh the bookings list after successful check-in
      fetchPendingBookings();
    } catch (err) {
  ...
  const openCheckInConfirmation = (booking) => {
  ...
  return (
    <div className="check-in-page">
      <h1 className="page-title">Pending Check-ins</h1>
                ...
                <tr key={booking._id}>
                  ...
                  <td className="actions-cell">
                    ...
                    <button
                      ...
                      onClick={() => openCheckInConfirmation(booking)}
                      title="Check In"
                    >
                      Check-In
                    </button>
        ...
        <div className="overlay">
          <div className="confirmation-popup">
            <div className="popup-header">
              ...
              <button className="close-button" onClick={closeCheckInConfirmation}>×</button>
            </div>
...
export default CheckInManagePage;
